...
export const metadata: Metadata = {
  ...
  creator: "SLOW",
  publisher: "SLOW",
  alternates: { canonical: "/", languages: { en: siteUrl, ar: `${siteUrl}/ar`, "x-default": siteUrl } },
  robots: { index: true, follow: true },
  icons: { icon: "/avatar-poster.jpg", shortcut: "/avatar-poster.jpg", apple: "/avatar-poster.jpg" },
  openGraph: { title: "SLOW — Developer, Creator & Builder", description: "Software, useful tools, AI experiments, services, gaming, and creator work.", url: siteUrl, siteName: "SLOW.DEV", images: [{ url: "/banner-poster.jpg", width: 1600, height: 565, alt: "SLOW.DEV" }], locale: "en_US", alternateLocale: ["ar_AR"], type: "website" },
...
const structuredData = {
  ...
  "@graph": [
    ...
    { "@type": "WebSite", "@id": `${siteUrl}/#website`, name: "SLOW.DEV", url: siteUrl, description: "Developer tools, projects, services, content, gaming, and creator features.", publisher: { "@id": `${siteUrl}/#person` }, inLanguage: ["en", "ar"] },
  ],
};
